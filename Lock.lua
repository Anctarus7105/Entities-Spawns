...
CustomDialog = {"You died to Lock ", "He is also fast, if a big wave sound happens hide quickly.", "his speed is unfathomable"},  -- Custom death message (can be as long as you want)
})
